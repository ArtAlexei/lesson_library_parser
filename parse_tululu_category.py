...
from download import download_image, download_txt, parse_book_page, check_for_redirect, total_pages
...
def main():
    ...
    parser.add_argument('--end_page', default=total_pages(), type=int)
