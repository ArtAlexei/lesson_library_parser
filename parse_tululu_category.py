...
parser.add_argument('--dest_folder', default=os.getcwd(), type=str, help='path to the directory with parsing results')
parser.add_argument('--skip_imgs', default=False, type=bool, help='do not download images')
parser.add_argument('--skip_txt', default=False, type=bool, help='do not download books')
parser.add_argument('--json_path', default=os.getcwd(), type=str, help='specify your path to *.json file with results')
    ...
    for book in books_from_page:
        ...
        try:
            ...
            if not args.skip_txt:
                ...
                params = {'id': book_id}
                book['file_path'] = download_txt(url,
                                                 params,
